...
export const SkillsChart: React.FC<SkillsChartProps> = ({ skills, topLanguages }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full mt-8">
      ...
      <div className="bg-slate-900 rounded-xl p-6 border border-slate-800 min-w-0 flex flex-col">
        <h3 className="text-xl font-bold mb-6 text-white flex items-center shrink-0">
